...
| P2 | Wire `SchemaContext` from catalog into dispatch — see [Catalog Provider](./catalog-integration) | **Done** (`fallback`/`glue`; `hiveMetastore`/`engineDelegate` still planned) |
