...
├── website/                      # Docusaurus site (published docs)
...
| `queryflux-frontend` | Trino HTTP, PostgreSQL wire, MySQL wire, Snowflake HTTP, Flight SQL, dispatch |
...
| `website/` | Published Docusaurus docs |
